...
router.get('/top5listpairs/:user', auth.verify, Top5ListController.getTop5ListPairsByUser)
router.get('/alltop5lists', auth.verify, Top5ListController.getAllTop5Lists)
